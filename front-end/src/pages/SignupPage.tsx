...
import { UsersServerAddressHttp, ApiEndpoints, HttpStatusCodes } from '../constants/backend-constants'
...
const SignupPage = () => {
    ...
    const HandleSignup = async () => {
        ...
        const res = await fetch(UsersServerAddressHttp + ApiEndpoints.signUp, {
            method: 'POST',
