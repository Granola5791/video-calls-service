...
import { ApiEndpoints, UsersServerAddressHttp, HttpStatusCodes } from "../constants/backend-constants"
...
const LoginPage = () => {
    ...
    const handleLogin = async (username: string, password: string) => {
        ...
        const res = await fetch(UsersServerAddressHttp + ApiEndpoints.logIn, {
            method: 'POST',
